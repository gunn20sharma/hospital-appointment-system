    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prescriptions', to='stores.appointment')),
                ('treatments', models.ManyToManyField(to='stores.treatment')),
            ],
        ),
    ]
